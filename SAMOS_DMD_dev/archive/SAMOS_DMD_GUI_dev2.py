...
# =============================================================================
    def dmd_initialize(self):
        DMD.initialize()
        DMD._open()
        self.img= ImageTk.PhotoImage(Image.open("/Users/samos_dev/GitHub/SAMOS_GUI_Python/SAMOS_DMD_dev/current_dm_state.png"))
    ...
    def dmd_invert(self):
        DMD.apply_invert()
        image = Image.open("/Users/samos_dev/GitHub/SAMOS_GUI_Python/SAMOS_DMD_dev/current_dm_state.png")
        image=image.convert("L")
        image_invert = ImageOps.invert(image)
        image_invert.save("/Users/samos_dev/GitHub/SAMOS_GUI_Python/SAMOS_DMD_dev/current_dm_state.png")
        # global img
        #img= ImageTk.PhotoImage(Image.open("/Users/samos_dev/GitHub/SAMOS_GUI_Python/SAMOS_DMD_dev/current_dm_state.png"))
