...
# #===#===#===#===#===#===#===#===#===#===#===#===#===#===#===#===#===#===#===#===#===#===#===#===#=====
        self.SourcePickup_YN = tk.IntVar()
        wslit = tk.Checkbutton(labelframe_SlitConf, text="Source Pickup",
                               variable=self.SourcePickup_YN, command=self.set_slit_drawtype)
...
# #===#===#===#===#===#===#===#===#===#===#===#===#===#===#===#===#===#===#===#===#===#===#===#===#=====
    ...
    def collect_slit_shape(self):
        ...
        for obj in objects:
            ...
            elif self.SourcePickup_YN.get() != 0 and obj.kind == 'point':
                x1, y1 = convert.CCD2DMD(ccd_x0, ccd_y0)
...
#        obj.add_callback('pick-down', self.pick_cb, 'down')
        ...
        kind = self.wdrawtype.get()
        print("kind: ", kind)
        if kind == "box" and self.SourcePickup_YN.get() != 0:
            if self.SlitTabView is None:
                self.initialize_slit_table()
            try:
                kind == "box"
        ...
        if self.SourcePickup_YN.get() != 0 and kind == 'point':  # or kind == 'box':
            true_kind = 'Slit'
            print("It is a slit")
