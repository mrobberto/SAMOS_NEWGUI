...
#
       ...
       # mos_path = homedir + '/mosfire/'
        sky_path = homedir + '/Paranal_sky_VIS/'
        #tp_path = homedir + '/MosfireSpecEff/'
        #bk_path = homedir + '/MosfireSkySpec/'
        self.results_path = homedir + '/SAMOS_Results/'
...
# Al from National Bureau of Standards, certainly optimistic
        Al_reflectivity = np.loadtxt(os.path.join(homedir,"coating_throughput","Al_reflectance_NBS.txt")) #lambda[nm], transmission
