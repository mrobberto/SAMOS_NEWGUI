...
"""
Simbad_name = "SDSS J213512.20-010255.8"
Target_name = "MACS-J2135-0102" #"Simbad_Name"
...
if dec_center <= 0:
    SkyMapper_phot_pandas = Cat.query_region_SkyMapper(ra_center *u.deg, dec_center*u.deg, radius = 2)
