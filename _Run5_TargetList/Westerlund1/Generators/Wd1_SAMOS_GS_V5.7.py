...
"""
Simbad_name = "Westerlund 1"
Target_name = "Westerlund 1" #"Simbad_Name"
...
catfile = '../Wd1_HSTandSOFIand2MASSandGAIA_MRCut.csv'
#or
...
IN THIS CASE THE TABLE HAS BEEN ALREADY SORTED...
...
main_pdtable_ranked_withNAN = main_ap_table_infield.to_pandas()
main_pdtable_w = main_pdtable_ranked_withNAN.dropna(subset=['RA'])
...
main_pdtable_w = pd.read_csv("../table_to_be_ranked_w.csv")
