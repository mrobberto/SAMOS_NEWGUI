...
class Catalogs():
    ...
    def get_2Mass_image(self,Target_name,radec_center):
    ...
    ### IS                                    
        ...
        #print(slits[0])
        try:
            print(RA_Center.unit)
            RA_Center = RA_Center.value
            DEC_Center = DEC_Center.value
        except:
            print("RA, DEC have no units, ok.")
    ...
    def query_region_SkyMapper(self, ra_DD, dec_DD, radius = 3):
        ...
        string += "RA=" + str(ra_DD.value) + "&"
        string += "DEC=" + str(dec_DD.value) + "&"
