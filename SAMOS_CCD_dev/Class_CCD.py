...
#ConvertSIlly courtesy of C. Loomis
    ...
    # Header cards:
        ...
        buf = buf.replace(b"INSTRUME= Spectral Instruments, Inc. 850-406 camera  ", b"INSTRUME= 'SI 850-406'")
    ...
    def expose(self,host='172.16.0.245',port=80):
        ...
        if 3<=len(sys.argv):
            ...
            #iterations=1  #to be fixed
            iterations=self.NofFrames  #to be fixed
        ### end of sys.argv
