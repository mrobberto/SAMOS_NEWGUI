...
#class GUI_SOAR(tk.Tk):#tk.Toplevel):  #this is a sublclass of whatver is Toplevel
class GUI_SOAR(tk.Toplevel):  #this is a sublclass of whatver is Toplevel
...
# =============================================================================
    def SOAR_way(self):
        return_string = SOAR.way()
              
        
    def SOAR_blackout(self):
        SOAR.apply_blackout()
        # global img
    ...
    def SOAR_checkerboard(self):
        SOAR.apply_checkerboard()
        # global img
        shutil.copy(local_dir + "/checkerboard.png",local_dir + "/current_SOAR_state.png")
        time.sleep(1)
        image_map = Image.open(local_dir + "/current_SOAR_state.png")
        self.img= ImageTk.PhotoImage(image_map)
        #Add image to the Canvas Items
    ...
    def SOAR_invert(self):
        SOAR.apply_invert()
        image_map = Image.open(local_dir + "/current_SOAR_state.png")
        image=image_map.convert("L")
        image_invert = ImageOps.invert(image)
        image_invert.save(local_dir + "/current_SOAR_state.png")
        # global img
        #img= ImageTk.PhotoImage(Image.open(local_dir + "/current_SOAR_state.png"))
...
#        self.canvas.create_image(104,128,image=img)
    ...
    def SOAR_antinvert(self):
        SOAR.apply_antinvert()
        image_map = Image.open(local_dir + "/current_SOAR_state.png")
        self.img= ImageTk.PhotoImage(image_map)
        #Add image to the Canvas Items
        self.canvas.create_image(104,128,image=self.img)
...
#         image_map.close()
    ...
    def enter_command(self):       
        ...
        t = SOAR.send_command_string(self.Command_string.get()) #convert StringVar to string
