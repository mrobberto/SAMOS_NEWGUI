...
# #===#===#===#===#===#===#===#===#===#===#===#===#===#===#===#===#===#===#===#===#===#===#===#===#=====
        ...
        """ THESE DEFINITIONS ARE NOW in self.PAR (SAMOS_Parameters_out.py)
...
#        PCM.initialize(address=host, port=int(port))
        ...
        if self.image_type == "sci":
            imtype = "sci_{}".format(self.FW_filter.get())  # e.g. 'sci_SLOAN-i'
            obj_type = "SCI"
        elif self.image_type == "bias":
            imtype = "bias"
            obj_type = "BIAS"
...
#            imtype = "dark_{}s".format(self.ExpTime.get())
        ...
        out_fname = os.path.join(self.fits_dir, imtype+basename)
        # e.g. 'd:\\samos_newgui\\..\\SISI_images\\SAMOS_20230927\\sci_SLOAN-i_Test''d:\\samos_newgui\\..\\SISI_images\\SAMOS_20230927\\sci_SLOAN-i_Test'
        ...
        # e.g. 'D:\\SAMOS_NEWGUI\\SAMOS_QL_images\\newimage.fit'
        """
        self.fits_image = os.path.join(
        ...
        hdul.close()
        input_header = hdul[0].header  #the input header produced by the S.I. camera
        ...
        # i.e. D:\SAMOS_NEWGUI\SAMOS_QL_images\newimage.fit
...
#        print(full_fpath)
       ...
       #     DMD.current_dmd_shape = None
        ...
        for night_file in Camera.img_night_dir_list:
            ...
            hdu = fits.open(night_file,mode = 'update')
            
            pr_hdu = hdu[0]
            del pr_hdu.header['INSTRUME']
            main_fits_header.set_param(
            ...
            night_file_DMD = night_file[:-5]+'_DMD.fits'
            hdulist.writeto(night_file_DMD, overwrite=True)
            hdu.close()
            hdulist.close()
